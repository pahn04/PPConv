...
from modules import SharedMLP, PointNetAModule, PointNetFPModule

from modules import Conv_pillar_iwf as Conv_module
#from modules import Conv_pillar_caf as Conv_module

from modules import PointNetSAModule as SA_Module
...
def create_pointnet_components(blocks, in_channels, with_se=False, normalize=True, eps=0,
    ...
    for out_channels, num_blocks, voxel_resolution in blocks:
        ...
        if voxel_resolution is None:
            ...
            block = functools.partial(Conv_module, kernel_size=3, resolution=int(vr * voxel_resolution),
...
def create_pointnet2_sa_components(sa_blocks, extra_feature_channels, with_se=False, normalize=True, eps=0,
    ...
    for conv_configs, sa_configs in sa_blocks:
        ...
        if num_centers is None:
            ...
            block = functools.partial(SA_Module,
                                      num_centers=num_centers, radius=radius, num_neighbors=num_neighbors)
