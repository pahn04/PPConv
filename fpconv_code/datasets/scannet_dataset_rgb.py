...
class ScannetDataset(torch_data.Dataset):
    def __init__(self, root=None, npoints=10240, split='train', with_dropout=False, with_norm=False, with_rgb=False, sample_rate=None, transform=None):
        super().__init__()
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            point_set, semantic_seg = self.transform(point_set, semantic_seg)
